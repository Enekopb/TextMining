...
public class DatuakLortu {
	//Datuak .csv edo .txt .arff-ra pasatu.
	
		public static void main(String[] args) throws IOException {
			args= new String[] {"/home/eneko/Descargas/0_PHMRC_VAI_redacted_free_text(1).csv", "/home/eneko/Escritorio/DatuakProba.arff"};
			errenkadaHutsakKendu(args[0]);
			System.out.println("1. pausua eginda!!!");
			String gs_text = klaseakLortu(args[0]);
			gs_text = gs_text.replaceAll("\\[|\\]|/", "");
			System.out.println("2. pausua eginda!!!");
			PrintWriter pw = new PrintWriter(args[1]);
			pw.println("@relation verbalAutopsy\n");
			pw.println("@attribute module_attrb {'neonate', 'child', 'adult'}");
			pw.println("@attribute site_attrb {'ap', 'dar', 'up', 'pemba', 'bohol', 'mexico'}");
			pw.println("@attribute gs_text34 {" + gs_text + "}");
			pw.println("@attribute sex_attrb {'1', '2', '8', '9'}");
			...
			while (scanner.hasNextLine()) {
				...
				//Hacer un split para quitar el id y poner entre comillas el string.
			...
			scanner.close();
			pw.close();
			//Hacer un metodo para quitar los numeros del split[8], para tener menos atributos al hacer el attrSElection
